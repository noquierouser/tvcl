...
echo "[" . date("d-m-y H:i:s") . "] ", "VTR DEPORTES scraper start!", PHP_EOL;
...
$dict_canales = array(
  "518992874" => "cl.ext.vivedeportes",
  "518993219" => "cl.ext.teletrak"
);

$grilla_url = "http://televisionvtr.cl/index.php?obt=grillacat&canal_tipo=deportes&fecha=%FECHA%&comuna=Santiago&canal_cantidad=20&_=" . time();
$grilla_fields = "%FECHA%";

$detalles_url = "http://televisionvtr.cl/index.php?obt=minificha&channels=%CHANNELID%&programs=%PROGRAMID%&starttime=%STARTTIME%&startdate=%STARTDATE%&canal_tipo=Deportes&_=" . time();
...
echo "[" . date("d-m-y H:i:s") . "] ", "VTR DEPORTES scraper done!", PHP_EOL;
